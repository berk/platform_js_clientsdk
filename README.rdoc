...
To get started, you'll need to add the library to your page, and initialize your app by calling _Platform.init()_, passing in your application key. 
The best place to put this is at the bottom of your page, before the closing _body_ tag to prohibit blocking parallel downloads as described in 
